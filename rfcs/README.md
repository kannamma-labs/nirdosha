...
| [0021](./0021-typed-hi-graph-mcp-and-incremental-authoring.md) | Typed Hi graph, project-scoped MCP reads/writes, resumable incremental authoring, and deterministic graph-to-v2-`.nir` emission — proposed, not implemented |

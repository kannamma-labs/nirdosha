...
//! `compiler/src/main.rs::cmd_serve` (a hand-rolled
...
// Identical to `compiler/src/main.rs::cmd_serve`'s own `read_token_file`:
...
/// same audience `KUBERNETES.md` scopes the rest of this feature to, not

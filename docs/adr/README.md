...
| [0013](./0013-postgres-store-driver-pooling-and-rls.md) | Postgres `StoreDriver` — duplicated pooling/TLS, RLS via session variables, resource-keyed tenant handoff | accepted |

...
/// (docs/goal.md row 9) should drive the stages directly instead.
...
pub fn run_program_with_tracer_transact_and_workflow_log(
    ...
    // Crash replay (`docs/TRANSACT.md`'s Layer 4) before `main` ever runs --
    ...
    // Same textual pre-check gate, for `docs/WORKFLOW.md`'s own replay pass.

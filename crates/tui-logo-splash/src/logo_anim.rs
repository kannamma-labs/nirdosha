...
//!
//! Copy this file + `logo_pixels.rs` into your own TUI app and call
//! [`render`] from your draw function with elapsed-time-since-start; it
//! has no dependency on anything else in this demo crate.

use ratatui::buffer::Buffer;
use ratatui::layout::Rect;
use ratatui::style::{Color, Modifier, Style};

use crate::logo_pixels::{LOGO, LOGO_H, LOGO_W};
